...
#+begin_src emacs-lisp :noweb-ref user-config
  (with-eval-after-load 'org
    ...
    ;; org directories
    (setq org-directory "~/personal/org-files-new/")
    ...
    (setq org-journal-dir "~/personal/org-files-new/journal/"
    ...
    ;; Context tags for work/personal separation and GTD workflow
