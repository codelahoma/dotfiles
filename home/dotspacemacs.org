...
#+RESULTS:
| #s(mu4e-context Work nil nil (lambda (msg) (when msg (string-prefix-p /Gmail (mu4e-message-field msg :maildir)))) ((user-mail-address . rod@atlasup.com) (user-full-name . Rod Knowlton) (mu4e-drafts-folder . /Gmail/[Gmail]/Drafts) (mu4e-sent-folder . /Gmail/[Gmail]/Sent Mail) (mu4e-refile-folder . /Gmail/[Gmail]/All Mail) (mu4e-trash-folder . /Gmail/[Gmail]/Trash) (mu4e-maildir-shortcuts (:maildir /Gmail/Inbox :key 105) (:maildir /Gmail/[Gmail]/Sent Mail :key 115) (:maildir /Gmail/[Gmail]/Drafts :key 100) (:maildir /Gmail/[Gmail]/All Mail :key 97) (:maildir /Gmail/[Gmail]/Trash :key 116) (:maildir /Gmail/[Gmail]/Spam :key 106)))) | #s(mu4e-context Personal nil nil (lambda (msg) (when msg (string-prefix-p /Fastmail (mu4e-message-field msg :maildir)))) ((user-mail-address . rod@rodknowlton.com) (user-full-name . Rod Knowlton) (mu4e-drafts-folder . /Fastmail/Drafts) (mu4e-sent-folder . /Fastmail/Sent) (mu4e-refile-folder . /Fastmail/Archive) (mu4e-trash-folder . /Fastmail/Trash) (mu4e-maildir-shortcuts (:maildir /Fastmail/INBOX :key 105) (:maildir /Fastmail/Sent Items :key 115) (:maildir /Fastmail/Drafts :key 100) (:maildir /Fastmail/Archive :key 97) (:maildir /Fastmail/Trash :key 116) (:maildir /Fastmail/Junk Mail :key 106)))) |
