...
before packages are loaded."
  ...
  (let* ((variable-tuple
    ...
    (custom-theme-set-faces
     ...
     '(variable-pitch ((t (:family "Avenir Next" :height 1.1))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(company-scrollbar-bg ((t (:background "#ffffffffffff"))) t)
 '(company-scrollbar-fg ((t (:background "#f8e5f751f687"))) t)
 '(company-tooltip ((t (:weight bold :foreground "dark red" :background "khaki1" :inherit default))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 '(company-tooltip-selection ((t (:inherit font-lock-function-name-face))))
 '(fixed-pitch ((t (:family "FiraCode Nerd Font" :height 1.0))))
 ...
 '(org-document-info ((t (:foreground "dark orange"))))
 '(org-document-info-keyword ((t (:inherit (shadow fixed-pitch)))))
 '(org-document-title ((t (:inherit default :weight normal :font "Avenir Next" :height 2.5 :underline nil))))
 '(org-done ((t (:font "Fira Sans" :height 0.6 :background nil))))
 '(org-indent ((t (:inherit (org-hide fixed-pitch)))))
 '(org-level-1 ((t (:inherit default :weight normal :font "Avenir Next" :height 2.0))))
 '(org-level-2 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.8))))
 '(org-level-3 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.6))))
 '(org-level-4 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.4))))
 '(org-level-5 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.2))))
 '(org-level-6 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.2))))
 '(org-level-7 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.2))))
 '(org-level-8 ((t (:inherit default :weight normal :font "Avenir Next" :height 1.2))))
 '(org-link ((t (:foreground "royal blue" :underline t))))
 '(org-meta-line ((t (:inherit (font-lock-comment-face fixed-pitch)))))
 '(org-property-value ((t (:inherit fixed-pitch))) t)
 '(org-special-keyword ((t (:inherit (font-lock-comment-face fixed-pitch)))))
