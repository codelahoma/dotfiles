...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(company-scrollbar-bg ((t (:background "#3ad84d6d56b8"))) t)
 '(company-scrollbar-fg ((t (:background "#307f3fcf4778"))) t)
 '(company-tooltip ((t (:weight bold :foreground "systemBlueColor" :background "systemGrayColor" :inherit default))))
 '(company-tooltip-common ((t (:inherit font-lock-constant-face))))
 ...
 '(org-document-info ((t (:foreground "dark orange"))))
 '(org-document-info-keyword ((t (:inherit (shadow fixed-pitch)))))
 '(org-document-title ((t (:inherit default :weight normal :font "Source Sans Pro" :height 2.0 :underline nil))))
 '(org-done ((t (:font "Fira Sans" :height 0.6 :background nil))))
 '(org-indent ((t (:inherit (org-hide fixed-pitch)))))
 '(org-level-1 ((t (:inherit default :weight normal :font "Source Sans Pro" :height 1.75))))
 '(org-level-2 ((t (:inherit default :weight normal :font "Source Sans Pro" :height 1.5))))
 '(org-level-3 ((t (:inherit default :weight normal :font "Source Sans Pro" :height 1.25))))
 '(org-level-4 ((t (:inherit default :weight normal :font "Source Sans Pro" :height 1.1))))
 '(org-level-5 ((t (:inherit default :weight normal :font "Source Sans Pro"))))
 '(org-level-6 ((t (:inherit default :weight normal :font "Source Sans Pro"))))
 '(org-level-7 ((t (:inherit default :weight normal :font "Source Sans Pro"))))
 '(org-level-8 ((t (:inherit default :weight normal :font "Source Sans Pro"))))
 '(org-link ((t (:foreground "royal blue" :underline t))))
 '(org-meta-line ((t (:inherit (font-lock-comment-face fixed-pitch)))))
 '(org-property-value ((t (:inherit fixed-pitch))) t)
 '(org-special-keyword ((t (:inherit (font-lock-comment-face fixed-pitch)))))
