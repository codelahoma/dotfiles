...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ace-link add-node-modules-path afternoon-theme aggressive-indent alect-themes
              all-the-icons ample-theme ample-zen-theme ansible ansible-doc
              ...
              command-log-mode company-anaconda company-ansible company-box
              company-emoji company-lua company-quickhelp company-restclient
              company-statistics company-web compleseus-spacemacs-help
              consult-lsp consult-yasnippet copilot copy-as-format csv-mode
              cyberpunk-theme cython-mode dakrone-theme dap-mode darkmine-theme
              darkokai-theme darktooth-theme devdocs diff-hl diminish
              dired-quick-sort direnv disable-mouse django-theme docker
              ...
              persistent-scratch phoenix-dark-mono-theme phoenix-dark-pink-theme
              pinboard pip-requirements pipenv pippel planet-theme plantuml-mode
              ...
              tangotango-theme tao-theme term-cursor terminal-here texfrag tide
              toc-org toml-mode toxi-theme tree-sitter-langs treemacs-evil
              ...
              underwater-theme undo-fu undo-fu-session unkillable-scratch
              vertico vi-tilde-fringe vim-powerline volatile-highlights vundo
              wakatime-mode web-beautify web-mode wgrep which-key
              white-sand-theme window-purpose winum writeroom-mode ws-butler
              wsd-mode yaml-mode yapfify yasnippet-snippets zen-and-art-theme
